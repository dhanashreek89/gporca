...
namespace gpdbcost
{
	...
	private:
		...
		static CCost CostUnary(DOUBLE rows,
							   DOUBLE width,
							   DOUBLE num_rebinds,
		...
		// cost of spooling
		static CCost CostSpooling(DOUBLE rows,
								  DOUBLE width,
								  DOUBLE num_rebinds,
								  DOUBLE *pdcostChildren,
								  ICostModelParams *pcp);
		...
		static CCost CostRedistribute(DOUBLE rows, DOUBLE width, ICostModelParams *pcp);
	...
	public:
		// ctor
		CCostModelGPDBLegacy(IMemoryPool *mp,
							 ULONG ulSegments,
