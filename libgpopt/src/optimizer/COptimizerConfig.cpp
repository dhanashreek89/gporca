...
//---------------------------------------------------------------------------
void
COptimizerConfig::Serialize(IMemoryPool *mp,
							...
							CBitSet *pbsTrace) const
{
	...
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenPlanSamples),
								 m_enumerator_cfg->GetPlanId());
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenCostThreshold),
								 m_enumerator_cfg->GetPlanId());
	...
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenOidRowNumber),
	...
	xml_serializer->AddAttribute(
		CDXLTokens::GetDXLTokenStr(EdxltokenJoinArityForAssociativityCommutativity),
	...
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenJoinOrderDPThreshold),
								 m_hint->UlJoinOrderDPLimit());
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenBroadcastThreshold),
