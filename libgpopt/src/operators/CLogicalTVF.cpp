...
//
//---------------------------------------------------------------------------
CLogicalTVF::CLogicalTVF(IMemoryPool *mp)
	: CLogical(mp),
	  m_func_mdid(NULL),
...
CLogicalTVF::HashValue() const
{
	ULONG ulHash = gpos::CombineHashes(
		...
		gpos::CombineHashes(
			...
			gpos::CombineHashes(m_return_type_mdid->HashValue(),
...
//---------------------------------------------------------------------------
COperator *
CLogicalTVF::PopCopyWithRemappedColumns(IMemoryPool *mp,
										...
										BOOL must_exist)
{
	...
	return GPOS_NEW(mp)
		CLogicalTVF(mp, m_func_mdid, m_return_type_mdid, str, m_pdrgpcoldesc, pdrgpcrOutput);
}
...
//---------------------------------------------------------------------------
CColRefSet *
CLogicalTVF::PcrsDeriveOutput(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
CFunctionProp *
CLogicalTVF::PfpDerive(IMemoryPool *mp, CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
CXformSet *
CLogicalTVF::PxfsCandidates(IMemoryPool *mp) const
{
...
//---------------------------------------------------------------------------
CMaxCard
CLogicalTVF::Maxcard(IMemoryPool *,		  // mp
					 CExpressionHandle &  // exprhdl
					 ) const
{
	if (m_returns_set)
...
IStatistics *
CLogicalTVF::PstatsDerive(IMemoryPool *mp,
						  CExpressionHandle &exprhdl,
