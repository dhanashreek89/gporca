...
//
//---------------------------------------------------------------------------
CPhysicalPartitionSelectorDML::CPhysicalPartitionSelectorDML(IMemoryPool *mp,
															 IMDId *mdid,
															 UlongToExprMap *phmulexprEqPredicates,
															 CColRef *pcrOid)
	: CPhysicalPartitionSelector(mp, mdid, phmulexprEqPredicates), m_pcrOid(pcrOid)
{
...
CPhysicalPartitionSelectorDML::Matches(COperator *pop) const
{
	...
	return popPartSelector->MDId()->Equals(m_mdid) && popPartSelector->PcrOid() == m_pcrOid &&
...
//---------------------------------------------------------------------------
CPartFilterMap *
CPhysicalPartitionSelectorDML::PpfmDerive(IMemoryPool *,  //mp,
...
//---------------------------------------------------------------------------
CDistributionSpec *
CPhysicalPartitionSelectorDML::PdsRequired(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
COrderSpec *
CPhysicalPartitionSelectorDML::PosRequired(IMemoryPool *mp,
										   CExpressionHandle &exprhdl,
...
CPhysicalPartitionSelectorDML::PppsRequired(IMemoryPool *mp,
											CExpressionHandle &exprhdl,
...
//---------------------------------------------------------------------------
CPartIndexMap *
CPhysicalPartitionSelectorDML::PpimDerive(IMemoryPool *,  //mp,
										  CExpressionHandle &exprhdl,
...
CPhysicalPartitionSelectorDML::EpetOrder(CExpressionHandle &exprhdl, const CEnfdOrder *peo) const
{
...
//---------------------------------------------------------------------------
CEnfdProp::EPropEnforcingType
CPhysicalPartitionSelectorDML::EpetDistribution(CExpressionHandle &exprhdl,
