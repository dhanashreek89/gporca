...
//
//---------------------------------------------------------------------------
CLogicalGbAggDeduplicate::CLogicalGbAggDeduplicate(IMemoryPool *mp)
...
//---------------------------------------------------------------------------
COperator *
CLogicalGbAggDeduplicate::PopCopyWithRemappedColumns(IMemoryPool *mp,
													 ...
													 BOOL must_exist)
{
	...
	return GPOS_NEW(mp)
		CLogicalGbAggDeduplicate(mp, colref_array, pdrgpcrMinimal, Egbaggtype(), pdrgpcrKeys);
}
...
//---------------------------------------------------------------------------
CColRefSet *
CLogicalGbAggDeduplicate::PcrsStat(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
CKeyCollection *
CLogicalGbAggDeduplicate::PkcDeriveKeys(IMemoryPool *mp,
										CExpressionHandle &  //exprhdl
										) const
{
...
//---------------------------------------------------------------------------
CXformSet *
CLogicalGbAggDeduplicate::PxfsCandidates(IMemoryPool *mp) const
{
...
//---------------------------------------------------------------------------
IStatistics *
CLogicalGbAggDeduplicate::PstatsDerive(IMemoryPool *mp,
									   CExpressionHandle &exprhdl,
									   ...
									   ) const
{
	...
	IStatistics *stats =
		CLogicalGbAgg::PstatsDerive(mp, child_stats, Pdrgpcr(), pdrgpulComputedCols, keys);
	keys->Release();
