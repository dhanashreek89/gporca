...
//
//---------------------------------------------------------------------------
CPhysicalMotionGather::CPhysicalMotionGather(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
CColRefSet *
CPhysicalMotionGather::PcrsRequired(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
COrderSpec *
CPhysicalMotionGather::PosRequired(IMemoryPool *mp,
								   CExpressionHandle &exprhdl,
								   COrderSpec *,  //posInput,
								   ULONG child_index,
								   CDrvdPropArrays *,  // pdrgpdpCtxt
...
//---------------------------------------------------------------------------
COrderSpec *
CPhysicalMotionGather::PosDerive(IMemoryPool *,		  // mp
								 CExpressionHandle &  // exprhdl
								 ) const
{
	m_pos->AddRef();
