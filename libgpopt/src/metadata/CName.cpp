...
//
//---------------------------------------------------------------------------
CName::CName(IMemoryPool *mp, const CWStringBase *str) : m_str_name(NULL), m_fDeepCopy(true)
{
...
//
//---------------------------------------------------------------------------
CName::CName(IMemoryPool *mp, const CName &nameFirst, const CName &nameSecond)
...
//
//---------------------------------------------------------------------------
CName::CName(IMemoryPool *mp, const CName &name) : m_str_name(NULL), m_fDeepCopy(false)
{
...
//---------------------------------------------------------------------------
void
CName::DeepCopy(IMemoryPool *mp, const CWStringConst *str)
{
	m_str_name = GPOS_NEW(mp) CWStringConst(mp, str->GetBuffer());
	m_fDeepCopy = true;
}
