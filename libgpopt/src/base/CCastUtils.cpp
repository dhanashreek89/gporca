...
CExpression *
CCastUtils::PexprCast(IMemoryPool *mp,
...
CExpressionArray *
CCastUtils::PdrgpexprCastEquality(IMemoryPool *mp, CExpression *pexpr)
{
	GPOS_ASSERT(pexpr->Pop()->FScalar());
...
CExpression *
CCastUtils::PexprAddCast(IMemoryPool *mp, CExpression *pexprPred)
{
