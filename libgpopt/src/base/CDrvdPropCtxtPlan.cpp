...
//
//---------------------------------------------------------------------------
CDrvdPropCtxtPlan::CDrvdPropCtxtPlan(IMemoryPool *mp, BOOL fUpdateCTEMap)
	: CDrvdPropCtxt(mp),
	  m_phmulpdpCTEs(NULL),
...
//---------------------------------------------------------------------------
CDrvdPropCtxt *
CDrvdPropCtxtPlan::PdpctxtCopy(IMemoryPool *mp) const
{
...
//---------------------------------------------------------------------------
void
CDrvdPropCtxtPlan::AddProps(DrvdPropArray *pdp)
{
...
CDrvdPropCtxtPlan::SetExpectedPartitionSelectors(COperator *pop, CCostContext *pcc)
{
	...
	m_ulExpectedPartitionSelectors =
		pcc->Poc()->Prpp()->Pepp()->PppsRequired()->Ppim()->UlExpectedPropagators(scan_id);
}
