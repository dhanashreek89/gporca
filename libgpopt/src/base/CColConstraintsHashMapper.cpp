...
PhmcolconstrSingleColConstr(IMemoryPool *mp, CConstraintArray *drgPcnstr)
{
...
CColConstraintsHashMapper::CColConstraintsHashMapper(IMemoryPool *mp, CConstraintArray *pdrgpcnstr)
