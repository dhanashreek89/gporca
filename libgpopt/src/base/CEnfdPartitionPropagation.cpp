...
//---------------------------------------------------------------------------
BOOL
CEnfdPartitionPropagation::FResolved(IMemoryPool *mp, CPartIndexMap *ppim) const
{
...
//---------------------------------------------------------------------------
BOOL
CEnfdPartitionPropagation::FInScope(IMemoryPool *mp, CPartIndexMap *ppim) const
{
	GPOS_ASSERT(NULL != ppim);
...
//---------------------------------------------------------------------------
const CHAR *
CEnfdPartitionPropagation::SzPropagationMatching(EPartitionPropagationMatching eppm)
{
	GPOS_ASSERT(EppmSentinel > eppm);
