...
//---------------------------------------------------------------------------
CColRefSet *
CFunctionalDependency::PcrsKeys(IMemoryPool *mp, const CFunctionalDependencyArray *pdrgpfd)
{
...
//---------------------------------------------------------------------------
CColRefArray *
CFunctionalDependency::PdrgpcrKeys(IMemoryPool *mp, const CFunctionalDependencyArray *pdrgpfd)
{
