...
//
//---------------------------------------------------------------------------
CColRefSet::CColRefSet(IMemoryPool *mp, ULONG ulSizeBits) : CBitSet(mp, ulSizeBits)
{
}
...
//
//---------------------------------------------------------------------------
CColRefSet::CColRefSet(IMemoryPool *mp, const CColRefSet &bs) : CBitSet(mp, bs)
{
}
...
//
//---------------------------------------------------------------------------
CColRefSet::CColRefSet(IMemoryPool *mp, const CColRefArray *colref_array, ULONG size)
	: CBitSet(mp, size)
{
...
//---------------------------------------------------------------------------
void
CColRefSet::Replace(const CColRefArray *pdrgpcrOut, const CColRefArray *pdrgpcrIn)
{
...
//---------------------------------------------------------------------------
CColRefArray *
CColRefSet::Pdrgpcr(IMemoryPool *mp) const
{
...
//---------------------------------------------------------------------------
void
CColRefSet::ExtractColIds(IMemoryPool *mp, ULongPtrArray *colids) const
{
	CColRefSetIter crsi(*this);
	while (crsi.Advance())
	{
