...
CXformLeftAntiSemiApplyNotIn2LeftAntiSemiJoinNotIn::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
void
CXformLeftAntiSemiApplyNotIn2LeftAntiSemiJoinNotIn::Transform(CXformContext *pxfctxt,
															  CXformResult *pxfres,
