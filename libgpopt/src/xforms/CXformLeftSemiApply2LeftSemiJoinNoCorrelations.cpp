...
CXformLeftSemiApply2LeftSemiJoinNoCorrelations::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
void
CXformLeftSemiApply2LeftSemiJoinNoCorrelations::Transform(CXformContext *pxfctxt,
														  CXformResult *pxfres,
