...
//---------------------------------------------------------------------------
BOOL
CXformSimplifySubquery::FSimplifyQuantified(IMemoryPool *mp,
...
//---------------------------------------------------------------------------
BOOL
CXformSimplifySubquery::FSimplifyExistential(IMemoryPool *mp,
											 CExpression *pexprScalar,
											 CExpression **ppexprNewScalar)
{
...
//---------------------------------------------------------------------------
BOOL
CXformSimplifySubquery::FSimplify(IMemoryPool *mp,
								  CExpression *pexprScalar,
								  CExpression **ppexprNewScalar,
...
//---------------------------------------------------------------------------
void
CXformSimplifySubquery::Transform(CXformContext *pxfctxt,
								  CXformResult *pxfres,
								  CExpression *pexpr) const
{
	...
	for (ULONG ul = 0; ul < size; ul++)
	{
		...
		if (!FSimplify(mp,
					   pexprScalar,
					   &pexprNewScalar,
					   m_rgssm[ul].m_pfnsimplify,
					   m_rgssm[ul].m_pfnmatch))
		{
