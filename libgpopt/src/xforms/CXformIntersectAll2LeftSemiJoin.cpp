...
//
//---------------------------------------------------------------------------
CXformIntersectAll2LeftSemiJoin::CXformIntersectAll2LeftSemiJoin(IMemoryPool *mp)
	: CXformExploration(
		  // pattern
										   ...
										   CExpression *pexpr) const
{
	...
	CExpression *pexprLSJ = GPOS_NEW(mp) CExpression(
		mp, GPOS_NEW(mp) CLogicalLeftSemiJoin(mp), pexprLeftWindow, pexprRightWindow, pexprScCond);
