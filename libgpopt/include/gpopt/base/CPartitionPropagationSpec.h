...
namespace gpopt
{
	...
	private:
		...
		BOOL FRequiresPartitionPropagation(IMemoryPool *mp,
										   CExpression *pexpr,
		...
		void SplitPartPredicates(IMemoryPool *mp,
