...
namespace gpopt
{
	...
	private:
		...
		static BOOL FOptimizeAgg(IMemoryPool *mp,
		...
		static BOOL FOptimizeSort(IMemoryPool *mp,
								  CGroupExpression *pgexprParent,
		...
		static BOOL FOptimizeMotion(IMemoryPool *mp,
									CGroupExpression *pgexprParent,
		...
		static BOOL FOptimizeNLJoin(IMemoryPool *mp,
									CGroupExpression *pgexprParent,
									CGroupExpression *pgexprMotion,
									COptimizationContext *poc,
									ULONG ulSearchStages);
	...
	public:
		...
		// debug print
		virtual IOstream &OsPrint(IOstream &os, const CHAR *szPrefix) const;

		// check equality of optimization contexts
		static BOOL
		Equals(const COptimizationContext &ocLeft, const COptimizationContext &ocRight)
		{
		...
		static BOOL FOptimize(IMemoryPool *mp,
							  CGroupExpression *pgexprParent,
		...
		static CReqdPropPlan *PrppCTEProducer(IMemoryPool *mp,
											  COptimizationContext *poc,
											  ULONG ulSearchStages);
