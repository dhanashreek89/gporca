...
namespace gpopt
{
	...
	private:
		...
		public:
			...
			CPartInfoEntry *PpartinfoentryAddRemappedKeys(IMemoryPool *mp,
														  CColRefSet *pcrs,
	...
	public:
		// ctor
		explicit CPartInfo(IMemoryPool *mp);
		...
		void AddPartConsumer(IMemoryPool *mp,
							 ULONG scan_id,
							 IMDId *mdid,
		...
		static CPartInfo *PpartinfoCombine(IMemoryPool *mp,
