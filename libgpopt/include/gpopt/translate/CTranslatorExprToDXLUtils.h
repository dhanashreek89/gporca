...
namespace gpopt
{
	...
	private:
		...
		static CDXLNode *PdxlnCmp(IMemoryPool *mp,
		...
		static CColRef *PcrCreate(IMemoryPool *mp,
								  CMDAccessor *md_accessor,
		...
		// array of part keys
		static ULONG UlPartKeyLevel(const CColRef *colref, CColRefArrays *pdrgpdrgpcr);

		// construct a test for a partial scan given a part constraint
		static CDXLNode *PdxlnPartialScanTest(IMemoryPool *mp,
											  CMDAccessor *md_accessor,
											  CColumnFactory *col_factory,
											  CConstraint *pcnstr,
		...
		static CDXLNode *PdxlnPartialScanTestConjDisj(IMemoryPool *mp,
													  CMDAccessor *md_accessor,
													  CColumnFactory *col_factory,
		...
		static CDXLNode *PdxlnPartialScanTestConjunction(IMemoryPool *mp,
														 CMDAccessor *md_accessor,
														 CColumnFactory *col_factory,
														 CConstraint *pcnstr,
														 CColRefArrays *pdrgpdrgpcrPartKeys,
		...
		static CDXLNode *PdxlnPartialScanTestDisjunction(IMemoryPool *mp,
														 CMDAccessor *md_accessor,
														 CColumnFactory *col_factory,
														 CConstraint *pcnstr,
														 CColRefArrays *pdrgpdrgpcrPartKeys,
		...
		static CDXLNode *PdxlnPartialScanTestNegation(IMemoryPool *mp,
													  CMDAccessor *md_accessor,
													  CColumnFactory *col_factory,
													  CConstraint *pcnstr,
													  CColRefArrays *pdrgpdrgpcrPartKeys,
		...
		static CDXLNode *PdxlnPartialScanTestInterval(IMemoryPool *mp,
													  CMDAccessor *md_accessor,
													  CConstraint *pcnstr,
													  CColRefArrays *pdrgpdrgpcrPartKeys,
													  BOOL fRangePart);
		...
		static CDXLNode *PdxlnPartialScanTestRange(IMemoryPool *mp,
												   CMDAccessor *md_accessor,
												   CRange *prng,
		...
		// start of the range
		static CDXLNode *PdxlnRangeStartPredicate(IMemoryPool *mp,
												  CMDAccessor *md_accessor,
												  IDatum *datum,
		...
		// construct a test for testing range containment with respect to the
		// end of the range
		static CDXLNode *PdxlnRangeEndPredicate(IMemoryPool *mp,
												CMDAccessor *md_accessor,
												IDatum *datum,
												CRange::ERangeInclusion eri,
												IMDId *pmdidPartKeyType,
		...
		static CDXLNode *PdxlnRangePointPredicate(IMemoryPool *mp,
												  CMDAccessor *md_accessor,
												  IDatum *datum,
												  CRange::ERangeInclusion eri,
												  IMDId *pmdidPartKeyType,
		...
		static CDXLNode *PdxlnDefaultPartitionTest(IMemoryPool *mp, ULONG ulPartLevel);

		// compute a DXL datum from a point constraint
		static CDXLDatum *PdxldatumFromPointConstraint(IMemoryPool *mp,
													   CMDAccessor *md_accessor,
		...
		static DXLDatumArrays *PdrgpdrgpdxldatumFromDisjPointConstraint(
			IMemoryPool *mp,
			CMDAccessor *md_accessor,
			const CColRef *pcrDistrCol,
			CConstraint *pcnstrDistrCol);
		...
		static CDXLDirectDispatchInfo *GetDXLDirectDispatchInfo(IMemoryPool *mp,
																CMDAccessor *md_accessor,
		...
		static CDXLDirectDispatchInfo *PdxlddinfoSingleDistrKey(IMemoryPool *mp,
																CMDAccessor *md_accessor,
		...
		static BOOL FDirectDispatchable(const CColRef *pcrDistrCol, const CDXLDatum *dxl_datum);

	public:
		// construct a default properties container
		static CDXLPhysicalProperties *GetProperties(IMemoryPool *mp);

		// create a scalar const value expression for the given bool value
		static CDXLNode *PdxlnBoolConst(IMemoryPool *mp, CMDAccessor *md_accessor, BOOL value);

		// create a scalar const value expression for the given int4 value
		static CDXLNode *PdxlnInt4Const(IMemoryPool *mp, CMDAccessor *md_accessor, INT val);

		// construct a filter node for a list partition predicate
		static CDXLNode *PdxlnListFilterScCmp(IMemoryPool *mp,
											  CMDAccessor *md_accessor,
		...
		static CDXLNode *PdxlnListFilterPartKey(IMemoryPool *mp,
												CMDAccessor *md_accessor,
		...
		static CDXLNode *PdxlnRangeFilterScCmp(IMemoryPool *mp,
											   CMDAccessor *md_accessor,
											   CDXLNode *pdxlnScalar,
											   IMDId *pmdidTypePartKey,
											   IMDId *pmdidTypeOther,
		...
		static CDXLNode *PdxlnRangeFilterEqCmp(IMemoryPool *mp,
											   CMDAccessor *md_accessor,
											   CDXLNode *pdxlnScalar,
											   IMDId *pmdidTypePartKey,
											   IMDId *pmdidTypeOther,
		...
		static CDXLNode *PdxlnRangeFilterPartBound(IMemoryPool *mp,
												   CMDAccessor *md_accessor,
												   CDXLNode *pdxlnScalar,
												   IMDId *pmdidTypePartKey,
												   IMDId *pmdidTypeOther,
		...
		static CDXLNode *PdxlnRangeFilterDefaultAndOpenEnded(IMemoryPool *mp,
															 ULONG ulPartLevel,
															 BOOL fLTComparison,
															 BOOL fGTComparison,
															 BOOL fEQComparison,
		...
		static CDXLNode *PdxlnProjListFromChildProjList(IMemoryPool *mp,
														CColumnFactory *col_factory,
														ColRefToDXLNodeMap *phmcrdxln,
														const CDXLNode *pdxlnProjListChild);

		// construct the project list of a partition selector
		static CDXLNode *PdxlnPrLPartitionSelector(IMemoryPool *mp,
												   CMDAccessor *md_accessor,
												   CColumnFactory *col_factory,
												   ColRefToDXLNodeMap *phmcrdxln,
		...
		static CDXLNode *PdxlnPropExprPartitionSelector(IMemoryPool *mp,
														CMDAccessor *md_accessor,
														CColumnFactory *col_factory,
														BOOL fConditional,
														UlongToPartConstraintMap *ppartcnstrmap,
		...
		static void ReplaceSubplan(IMemoryPool *mp,
								   ColRefToDXLNodeMap *phmcrdxlnSubplans,
								   const CColRef *colref,
		...
		static IDatumArray *PdrgpdatumNulls(IMemoryPool *mp, CColRefArray *colref_array);

		// map an array of columns to a new array of columns
		static CColRefArray *PdrgpcrMapColumns(IMemoryPool *mp,
		...
		static CDXLNode *PdxlnResult(IMemoryPool *mp,
									 CDXLPhysicalProperties *dxl_properties,
									 CDXLNode *pdxlnPrL,
		...
		static CDXLNode *PdxlnValuesScan(IMemoryPool *mp,
										 CDXLPhysicalProperties *dxl_properties,
										 CDXLNode *pdxlnPrL,
		...
		static ColRefToUlongMap *PhmcrulColIndex(IMemoryPool *mp, CColRefArray *colref_array);

		// set statistics of the operator
		static void SetStats(IMemoryPool *mp,
							 CMDAccessor *md_accessor,
							 CDXLNode *dxlnode,
		...
		static void SetDirectDispatchInfo(IMemoryPool *mp,
										  CMDAccessor *md_accessor,
										  CDXLNode *dxlnode,
		...
		static void ExtractCastMdids(COperator *pop, IMDId **ppmdidType, IMDId **ppmdidCastFunc);

		// produce DXL representation of a datum
		static CDXLDatum *
		GetDatumVal(IMemoryPool *mp, CMDAccessor *md_accessor, IDatum *datum)
		{
		...
		static CDXLPhysicalProperties *PdxlpropCopy(IMemoryPool *mp, CDXLNode *dxlnode);
		...
		static BOOL FMotionHazard(IMemoryPool *mp,
								  CDXLNode *dxlnode,
								  const gpdxl::Edxlopid *peopid,
								  ULONG ulOps,
								  CBitSet *pbsPrjCols);
