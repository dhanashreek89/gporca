...
namespace gpopt
{
	...
	typedef CHashMap<CColRef,
					 CDXLNode,
					 gpos::HashValue<CColRef>,
					 gpos::Equals<CColRef>,
					 CleanupNULL<CColRef>,
	...
	private:
		...
		CDXLNode *PdxlnTblScan(CExpression *pexprTblScan,
		...
		CDXLNode *PdxlnIndexScanWithInlinedCondition(CExpression *pexprIndexScan,
													 CExpression *pexprScalarCond,
													 CDXLPhysicalProperties *dxl_properties,
													 CColRefArray *colref_array,
													 CDistributionSpecArray *pdrgpdsBaseTables);
		...
		CDXLNode *PdxlnResult(CExpression *pexprFilter,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
							  BOOL *pfDML);
		...
		CDXLNode *PdxlnResult(CDXLNode *proj_list_dxlnode,
							  CExpression *pexprFilter,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
		...
		CDXLNode *PdxlnAddScalarFilterOnRelationalChild(CDXLNode *pdxlnRelationalChild,
		...
		CDXLNode *PdxlnAggregate(CExpression *pexprAgg,
								 CColRefArray *colref_array,
								 CDistributionSpecArray *pdrgpdsBaseTables,
								 ULONG *pulNonGatherMotions,
								 BOOL *pfDML,
		...
		CDXLNode *PdxlnSort(CExpression *pexprSort,
							CColRefArray *colref_array,
							CDistributionSpecArray *pdrgpdsBaseTables,
							ULONG *pulNonGatherMotions,
							BOOL *pfDML);

		CDXLNode *PdxlnLimit(CExpression *pexprLimit,
							 CColRefArray *colref_array,
							 CDistributionSpecArray *pdrgpdsBaseTables,
							 ULONG *pulNonGatherMotions,
							 BOOL *pfDML);

		CDXLNode *PdxlnWindow(CExpression *pexprSeqPrj,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
							  BOOL *pfDML);

		CDXLNode *PdxlnNLJoin(CExpression *pexprNLJ,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
							  BOOL *pfDML);

		CDXLNode *PdxlnHashJoin(CExpression *pexprHJ,
								CColRefArray *colref_array,
								CDistributionSpecArray *pdrgpdsBaseTables,
								ULONG *pulNonGatherMotions,
								BOOL *pfDML);
		...
		void BuildDxlnSubPlan(CDXLNode *pdxlnRelChild,
		...
		CDXLNode *PdxlnTblScanFromNLJoinOuter(CExpression *pexprRelational,
											  CDXLNode *pdxlnScalar,
											  CColRefArray *colref_array,
											  CDistributionSpecArray *pdrgpdsBaseTables,
											  ULONG *pulNonGatherMotions,
		...
		CDXLNode *PdxlnResultFromNLJoinOuter(CExpression *pexprRelational,
											 CDXLNode *pdxlnScalar,
											 CColRefArray *colref_array,
											 CDistributionSpecArray *pdrgpdsBaseTables,
											 ULONG *pulNonGatherMotions,
		...
		CDXLNode *PdxlnMotion(CExpression *pexprMotion,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
							  BOOL *pfDML);
		...
		CDXLNode *PdxlnDynamicBitmapTableScan(CExpression *pexprDynamicBitmapTableScan,
											  CColRefArray *colref_array,
											  CDistributionSpecArray *pdrgpdsBaseTables,
											  ULONG *pulNonGatherMotions,
											  BOOL *pfDML);
		...
		CDXLNode *PdxlnTVF(CExpression *pexprTVF,
						   CColRefArray *colref_array,
						   CDistributionSpecArray *pdrgpdsBaseTables,
						   ULONG *pulNonGatherMotions,
						   BOOL *pfDML);
		...
		CDXLNode *PdxlnPartitionSelectorDML(CExpression *pexpr,
											CColRefArray *pdrgpc,
											CDistributionSpecArray *pdrgpdsBaseTables,
											ULONG *pulNonGatherMotions,
											BOOL *pfDMLr);
		...
		CDXLNode *PdxlnPartitionSelectorExpand(CExpression *pexpr,
											   CColRefArray *colref_array,
											   CDistributionSpecArray *pdrgpdsBaseTables,
											   ULONG *pulNonGatherMotions,
											   BOOL *pfDML,
		...
		CDXLNode *PdxlnPartitionSelectorFilter(CExpression *pexpr,
											   CColRefArray *colref_array,
											   CDistributionSpecArray *pdrgpdsBaseTables,
											   ULONG *pulNonGatherMotions,
											   BOOL *pfDML,
		...
		CDXLNode *PdxlnPredOnPartKey(CExpression *pexprPred,
									 CColRef *pcrPartKey,
		...
		// comparison type flags accordingly
		CDXLNode *PdxlnScCmpPartKey(CExpression *pexprScCmp,
									CColRef *pcrPartKey,
									IMDId *pmdidTypePartKey,
									ULONG ulPartLevel,
									BOOL fRangePart,
		...
		CDXLNode *PdxlnScNullTestPartKey(IMDId *pmdidTypePartKey,
										 ULONG ulPartLevel,
										 BOOL fRangePart,
										 BOOL is_null);
		...
		CDXLNode *PdxlnPartitionSelectorChild(CExpression *pexprChild,
											  CExpression *pexprScalarCond,
											  CDXLPhysicalProperties *dxl_properties,
											  CColRefArray *colref_array,
											  CDistributionSpecArray *pdrgpdsBaseTables,
		...
		CDXLNode *PdxlnAssert(CExpression *pexprAssert,
							  CColRefArray *colref_array,
							  CDistributionSpecArray *pdrgpdsBaseTables,
							  ULONG *pulNonGatherMotions,
							  BOOL *pfDML);
		...
		CDXLNode *CreateDXLNode(CExpression *pexpr,
								CColRefArray *colref_array,
								CDistributionSpecArray *pdrgpdsBaseTables,
								ULONG *pulNonGatherMotions,
								BOOL *pfDML,
	...
	public:
		// ctor
		CTranslatorExprToDXL(IMemoryPool *mp,
		...
		// main driver
		CDXLNode *PdxlnTranslate(CExpression *pexpr,
								 CColRefArray *colref_array,
