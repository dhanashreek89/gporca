...
namespace gpopt
{
	...
	public:
		...
		static CExpression *PexprConstInt8(IMemoryPool *mp,
										   CMDAccessor *md_accessor,
										   CSystemId sysid,
										   LINT liValue);

		// create a scalar const operator from a DXL scalar const operator
		static CScalarConst *PopConst(IMemoryPool *mp,
									  CMDAccessor *md_accessor,
		...
		static CColRefArray *Pdrgpcr(IMemoryPool *mp,
