...
namespace gpopt
{
	...
	private:
		...
		static BOOL FCreateGrpCols(IMemoryPool *mp,
								   CExpression *pexprOuter,
								   CExpression *pexprInner,
								   BOOL fExistential,
								   BOOL fOuterRefsUnderInner,
		...
		static BOOL FCreateOuterApplyForExistOrQuant(IMemoryPool *mp,
													 CExpression *pexprOuter,
													 CExpression *pexprInner,
													 CExpression *pexprSubquery,
													 BOOL fOuterRefsUnderInner,
		...
		static BOOL FCreateOuterApply(IMemoryPool *mp,
									  CExpression *pexprOuter,
									  CExpression *pexprInner,
									  CExpression *pexprSubquery,
									  BOOL fOuterRefsUnderInner,
		...
		static CExpression *PexprScalarIf(IMemoryPool *mp,
										  CColRef *pcrBool,
										  CColRef *pcrSum,
										  CColRef *pcrCount,
										  CExpression *pexprSubquery);
		...
		static BOOL FCreateCorrelatedApplyForQuantifiedSubquery(IMemoryPool *mp,
																CExpression *pexprOuter,
																CExpression *pexprSubquery,
																ESubqueryCtxt esqctxt,
																CExpression **ppexprNewOuter,
		...
		static BOOL FCreateCorrelatedApplyForExistOrQuant(IMemoryPool *mp,
														  CExpression *pexprOuter,
														  CExpression *pexprSubquery,
														  ESubqueryCtxt esqctxt,
														  CExpression **ppexprNewOuter,
		...
		static SSubqueryDesc *Psd(IMemoryPool *mp,
								  CExpression *pexprSubquery,
								  CExpression *pexprOuter,
								  ESubqueryCtxt esqctxt);
		...
		static CExpression *PexprReplace(IMemoryPool *mp,
										 CExpression *pexpr,
										 CColRef *colref,
										 CExpression *pexprSubquery);
		...
		static BOOL FGenerateCorrelatedApplyForScalarSubquery(IMemoryPool *mp,
															  CExpression *pexprOuter,
															  CExpression *pexprSubquery,
															  ESubqueryCtxt esqctxt,
		...
		static BOOL FRemoveScalarSubqueryInternal(IMemoryPool *mp,
												  CExpression *pexprOuter,
												  CExpression *pexprSubquery,
												  ESubqueryCtxt esqctxt,
												  SSubqueryDesc *psd,
		...
		BOOL FRemoveAnySubquery(CExpression *pexprOuter,
								CExpression *pexprSubquery,
								ESubqueryCtxt esqctxt,
								CExpression **ppexprNewOuter,
								CExpression **ppexprResidualScalar);
		...
		BOOL FRemoveAllSubquery(CExpression *pexprOuter,
								CExpression *pexprSubquery,
								ESubqueryCtxt esqctxt,
								CExpression **ppexprNewOuter,
								CExpression **ppexprResidualScalar);
		...
		static BOOL FRemoveExistentialSubquery(IMemoryPool *mp,
		...
		static void AssertValidArguments(IMemoryPool *mp,
										 CExpression *pexprOuter,
										 CExpression *pexprScalar,
										 CExpression **ppexprNewOuter,
										 CExpression **ppexprResidualScalar);
	...
	public:
		// ctor
		CSubqueryHandler(IMemoryPool *mp, BOOL fEnforceCorrelatedApply)
