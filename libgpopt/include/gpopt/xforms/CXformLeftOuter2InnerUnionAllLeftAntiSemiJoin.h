...
namespace gpopt
{
	...
	private:
		...
		static CExpression *PexprLeftAntiSemiJoinWithInnerGroupBy(IMemoryPool *mp,
		...
		static CExpression *PexprProjectOverLeftAntiSemiJoin(IMemoryPool *mp,
															 CColRefArray *pdrgpcrOuter,
															 CColRefSet *pcrsScalar,
															 CColRefSet *pcrsInner,
															 CColRefArray *pdrgpcrJoinOutput,
	...
	public:
		// ctor
		explicit CXformLeftOuter2InnerUnionAllLeftAntiSemiJoin(IMemoryPool *mp);
