...
namespace gpopt
{
	...
	public:
		// ctor
		explicit CXformLeftSemiApply2LeftSemiJoinNoCorrelations(IMemoryPool *mp)
		...
		CXformLeftSemiApply2LeftSemiJoinNoCorrelations(IMemoryPool *mp, CExpression *pexprPattern)
