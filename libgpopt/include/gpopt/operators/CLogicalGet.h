...
namespace gpopt
{
	...
	private:
		...
		void CreatePartCols(IMemoryPool *mp, const ULongPtrArray *pdrgpulPart);
	...
	public:
		// ctors
		explicit CLogicalGet(IMemoryPool *mp);

		CLogicalGet(IMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc);
		...
		PopConvert(COperator *pop)
		{
			...
			GPOS_ASSERT(EopLogicalGet == pop->Eopid() || EopLogicalExternalGet == pop->Eopid());
