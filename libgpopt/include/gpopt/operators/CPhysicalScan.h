...
namespace gpopt
{
	...
	protected:
		...
		static CPartIndexMap *PpimDeriveFromDynamicScan(IMemoryPool *mp,
														ULONG part_idx_id,
														IMDId *rel_mdid,
	...
	private:
		...
		CDistributionSpecHashed *PdshashedDeriveWithOuterRefs(IMemoryPool *mp,
