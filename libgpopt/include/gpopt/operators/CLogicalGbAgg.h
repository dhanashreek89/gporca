...
namespace gpopt
{
	...
	protected:
		...
		CColRefSet *PcrsStatGbAgg(IMemoryPool *mp,
	...
	public:
		// ctor
		explicit CLogicalGbAgg(IMemoryPool *mp);
		...
		virtual CColRefSet *PcrsDeriveOuter(IMemoryPool *mp, CExpressionHandle &exprhdl);
