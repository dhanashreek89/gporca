...
namespace gpopt
{
	...
	public:
		...
		virtual CScalarCmp *PopCommutedOp(IMemoryPool *mp, COperator *pop);

		// get the string representation of a metadata object
		static CWStringConst *Pstr(IMemoryPool *mp, CMDAccessor *md_accessor, IMDId *mdid);
