...
namespace gpopt
{
	...
	private:
		...
		static void SplitPrjList(IMemoryPool *mp,
		...
		static void SplitSeqPrj(IMemoryPool *mp,
								CExpression *pexprSeqPrj,
		...
		static void CreateCTE(IMemoryPool *mp,
							  CExpression *pexprSeqPrj,
		...
		static CExpression *PexprSeqPrj2Join(IMemoryPool *mp, CExpression *pexprSeqPrj);

	public:
		// main driver
		static CExpression *PexprPreprocess(IMemoryPool *mp, CExpression *pexpr);
