...
namespace gpopt
{
	...
	protected:
		...
		void ExtractColIdsAttno(IMemoryPool *mp,
								CColRefSet *pcrs,
		...
		IStatistics *PstatsDeriveFilter(IMemoryPool *mp,
										CExpressionHandle &exprhdl,
										CExpression *pexprFilter) const;

	public:
		// ctors
		explicit CLogicalDynamicGetBase(IMemoryPool *mp);
