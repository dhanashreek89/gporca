...
namespace gpopt
{
	...
	private:
		...
		CDistributionSpec *PdsRequiredReplicate(IMemoryPool *mp,
												CExpressionHandle &exprhdl,
												CDistributionSpec *pdsInput,
												ULONG child_index,
												CDrvdPropArrays *pdrgpdpCtxt,
		...
		CDistributionSpec *PdsRequiredSingleton(IMemoryPool *mp,
												CExpressionHandle &exprhdl,
												CDistributionSpec *pdsInput,
												ULONG child_index,
		...
		CDistributionSpecHashed *PdshashedPassThru(IMemoryPool *mp,
												   CExpressionHandle &exprhdl,
	...
	protected:
		...
		CDistributionSpecHashed *PdshashedMatching(IMemoryPool *mp,
	...
	public:
		// ctor
		CPhysicalHashJoin(IMemoryPool *mp,
