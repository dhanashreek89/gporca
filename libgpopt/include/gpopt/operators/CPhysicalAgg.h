...
namespace gpopt
{
	...
	private:
		...
		CDistributionSpec *PdsRequiredGlobalAgg(IMemoryPool *mp,
		...
		static CDistributionSpec *PdsMaximalHashed(IMemoryPool *mp, CColRefArray *colref_array);
	...
	protected:
		...
		CColRefSet *PcrsRequiredAgg(IMemoryPool *mp,
									CExpressionHandle &exprhdl,
		...
		CDistributionSpec *PdsRequiredAgg(IMemoryPool *mp,
										  CExpressionHandle &exprhdl,
										  CDistributionSpec *pdsInput,
										  ULONG child_index,
										  ULONG ulOptReq,
	...
	public:
					...
					ULONG ulOptReq) const
		{
			return PdsRequiredAgg(
				mp, exprhdl, pdsRequired, child_index, ulOptReq, m_pdrgpcr, m_pdrgpcrMinimal);
		}
