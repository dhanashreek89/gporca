...
namespace gpopt
{
	...
	private:
		...
		static CHAR *SzMinidumpFileName(IMemoryPool *mp, const CHAR *file_name);
	...
	public:
		...
		static void InitProviderFile(IMemoryPool *mp);
		...
		static CTableDescriptor *PtabdescPlain(IMemoryPool *mp,
											   ULONG num_cols,
											   IMDId *mdid,
		...
		static CTableDescriptor *PtabdescPlainWithColNameFormat(IMemoryPool *mp,
																ULONG num_cols,
																IMDId *mdid,
		...
		static CTableDescriptor *PtabdescCreate(IMemoryPool *mp,
												ULONG num_cols,
												IMDId *mdid,
												const CName &name,
		...
		static CExpression *PexprLogicalGet(IMemoryPool *mp,
											CTableDescriptor *ptabdesc,
											const CWStringConst *pstrTableAlias);

		// generate a get expression over table with nullable columns
		static CExpression *PexprLogicalGetNullable(IMemoryPool *mp,
													OID oidTable,
		...
		static CExpression *PexprLogicalExternalGet(IMemoryPool *mp);

		// generate a random assert expression
		static CExpression *PexprLogicalAssert(IMemoryPool *mp);

		// generate a random get expression on a partitioned table
		static CExpression *PexprLogicalGetPartitioned(IMemoryPool *mp);

		// generate a randomized get expression for a partitioned table with indexes
		static CExpression *PexprLogicalDynamicGetWithIndexes(IMemoryPool *mp);

		// generate a select expression with random equality predicate
		static CExpression *PexprLogicalSelect(IMemoryPool *mp, CExpression *pexpr);

		// generate a select expression
		static CExpression *PexprLogicalSelect(IMemoryPool *mp,
											   CWStringConst *str_table_name,
											   CWStringConst *pstrTableAlias,
											   ULONG ulTableId);
		...
		static CExpression *PexprLogicalSelectOnOuterJoin(IMemoryPool *mp);

		// generate a join expression with a random equality predicate
		template <class T>
		static CExpression *PexprLogicalJoin(IMemoryPool *mp,
		...
		static CExpression *PexprLogicalJoinCorrelated(IMemoryPool *mp);

		// generate join with a partitioned and indexed inner child
		static CExpression *PexprLogicalJoinWithPartitionedAndIndexedInnerChild(IMemoryPool *mp);

		// generate a select expression with predicate between a scalar ident and a constant
		static CExpression *PexprLogicalSelectCmpToConst(IMemoryPool *mp);

		// generate a select expression with an array compare
		static CExpression *PexprLogicalSelectArrayCmp(IMemoryPool *mp);
		...
		static CExpression *PexprLogicalNAryJoin(IMemoryPool *mp, CExpressionArray *pdrgpexpr);

		// generate an n-ary join expression using given array of relation names
		static CExpression *PexprLogicalNAryJoin(IMemoryPool *mp,
		...
		static CExpression *PexprLeftOuterJoinOnNAryJoin(IMemoryPool *mp);

		// generate n-ary join on top of left outer join expression
		static CExpression *PexprNAryJoinOnLeftOuterJoin(IMemoryPool *mp);

		// generate a project expression
		static CExpression *PexprLogicalProject(IMemoryPool *mp,
												CExpression *pexpr,
												CColRef *colref,
												CColRef *new_colref);
		...
		static CExpression *PexprLogicalProjectGbAggCorrelated(IMemoryPool *mp);

		// generate a limit expression
		static CExpression *PexprLogicalLimit(IMemoryPool *mp,
											  CExpression *pexpr,
											  LINT iStart,
											  LINT iRows,
											  BOOL fGlobal,
		...
		static CExpression *PexprLogicalGbAgg(IMemoryPool *mp);

		// generate a random group by expression
		static CExpression *PexprLogicalGbAggWithInput(IMemoryPool *mp, CExpression *pexprInput);

		// generate a random group by with a sum expression
		static CExpression *PexprLogicalGbAggWithSum(IMemoryPool *mp);

		// generate a random group by over join expression
		static CExpression *PexprLogicalGbAggOverJoin(IMemoryPool *mp);

		// generate GbAgg with correlation beneath it
		static CExpression *PexprLogicalGbAggCorrelated(IMemoryPool *mp);

		// generate a dedup group by over inner join expression
		static CExpression *PexprLogicalGbAggDedupOverInnerJoin(IMemoryPool *mp);

		// generate a top-level apply expression
		template <class T>
		static CExpression *PexprLogicalApply(IMemoryPool *mp);

		// generate a top-level apply expression with an outer reference
		template <class T>
		static CExpression *PexprLogicalApplyWithOuterRef(IMemoryPool *mp);

		// generate a const table get expression
		static CExpression *PexprConstTableGet(IMemoryPool *mp, ULONG ulElements);

		// generate a const table get expression with 5 elements
		static CExpression *PexprConstTableGet5(IMemoryPool *mp);

		// generate a logical insert expression
		static CExpression *PexprLogicalInsert(IMemoryPool *mp);

		// generate a logical delete expression
		static CExpression *PexprLogicalDelete(IMemoryPool *mp);

		// generate a logical update expression
		static CExpression *PexprLogicalUpdate(IMemoryPool *mp);

		// generate a dynamic get expression
		static CExpression *PexprLogicalDynamicGet(IMemoryPool *mp,
												   CTableDescriptor *ptabdesc,
												   const CWStringConst *pstrTableAlias,
												   ULONG ulPartIndex);
		...
		static CExpression *PexprLogicalSelectWithEqPredicateOverDynamicGet(IMemoryPool *mp);

		// generate a select with a less than predicate over a dynamic get expression
		static CExpression *PexprLogicalSelectWithLTPredicateOverDynamicGet(IMemoryPool *mp);

		// generate a logical table-valued function expression with 2 constant arguments
		static CExpression *PexprLogicalTVFTwoArgs(IMemoryPool *mp);

		// generate a logical table-valued function expression with 3 constant arguments
		static CExpression *PexprLogicalTVFThreeArgs(IMemoryPool *mp);

		// generate a logical table-valued function expression with no arguments
		static CExpression *PexprLogicalTVFNoArgs(IMemoryPool *mp);

		// generate a logical table-valued function expression
		static CExpression *PexprLogicalTVF(IMemoryPool *mp, ULONG ulArgs);

		// generate a cte producer on top of a select
		static CExpression *PexprLogicalCTEProducerOverSelect(IMemoryPool *mp, ULONG ulCTEId);

		// generate a CTE producer on top of a select
		static CExpression *PexprLogicalCTEProducerOverSelect(IMemoryPool *mp);

		// generate an expression with CTE producer and consumer
		static CExpression *PexprCTETree(IMemoryPool *mp);

		// generate a logical sequence expression
		static CExpression *PexprLogicalSequence(IMemoryPool *mp, CExpressionArray *pdrgpexpr);

		// generate a logical sequence expression
		static CExpression *PexprLogicalSequence(IMemoryPool *mp);

		// generate a random union expression
		static CExpression *PexprLogicalUnion(IMemoryPool *mp, ULONG ulDepth);

		// generate a sequence project expression
		static CExpression *PexprLogicalSequenceProject(IMemoryPool *mp,
														OID oidFunc,
														CExpression *pexprInput);

		// generate a random expression with one window function
		static CExpression *PexprOneWindowFunction(IMemoryPool *mp);

		// generate a random expression with two window functions
		static CExpression *PexprTwoWindowFunctions(IMemoryPool *mp);

		// generate a dynamic array of join expressions
		static CExpressionJoinsArray *PdrgpexprJoins(IMemoryPool *mp,
													 CWStringConst *pstrRel,
													 ULONG *pulRel,
													 ULONG ulRels,
													 BOOL fCrossProduct);
		...
		static CQueryContext *PqcGenerate(IMemoryPool *mp,
										  CExpression *pexpr,
										  CColRefArray *colref_array);

		// generate a dummy query context for testing
		static CQueryContext *PqcGenerate(IMemoryPool *mp, CExpression *pexpr);

		// generate a nested AND/OR tree
		static CExpression *PexprScalarNestedPreds(IMemoryPool *mp,
												   CExpression *pexpr,
												   CScalarBoolOp::EBoolOperator eboolop);

		// find the first child expression with the given operator id
		static CExpression *PexprFindFirstExpressionWithOpId(CExpression *pexpr,
															 COperator::EOperatorId op_id);

		// equality predicate shortcut
		static void EqualityPredicate(IMemoryPool *mp,
									  CColRefSet *pcrsLeft,
									  CColRefSet *pcrsRight,
									  CExpressionArray *pdrgpexpr);

		// int2 point
		static CPoint *PpointInt2(IMemoryPool *mp, INT i);

		// int4 point
		static CPoint *PpointInt4(IMemoryPool *mp, INT i);

		// create an INT4 point with null value
		static CPoint *PpointInt4NullVal(IMemoryPool *mp);

		// int8 point
		static CPoint *PpointInt8(IMemoryPool *mp, INT li);

		// bool point
		static CPoint *PpointBool(IMemoryPool *mp, BOOL value);
		...
		static GPOS_RESULT EresTranslate(IMemoryPool *mp,
										 const CHAR *szQueryFileName,
										 const CHAR *szPlanFileName,
										 BOOL fIgnoreMismatch);

		// return query logical expression from minidump
		static CExpression *PexprReadQuery(IMemoryPool *mp, const CHAR *szQueryFileName);

		// compare expected and actual output
		static GPOS_RESULT EresCompare(IOstream &os,
		...
		static BOOL FPlanMatch(IMemoryPool *mp,
							   IOstream &os,
		...
		static BOOL FPlanCompare(IMemoryPool *mp,
								 IOstream &os,
								 const CDXLNode *first_child_dxlnode,
								 ULLONG ullPlanIdFst,
								 ULLONG ullPlanSpaceSizeFst,
		...
		static GPOS_RESULT EresRunMinidumps(IMemoryPool *mp,
		...
		static GPOS_RESULT EresRunMinidumpsUsingOneMDFile(IMemoryPool *mp,
		...
		static GPOS_RESULT EresRunMinidump(IMemoryPool *mp,
		...
		static IDatum *CreateGenericDatum(IMemoryPool *mp,
										  CMDAccessor *md_accessor,
										  IMDId *mdid_type,
		...
		static CConstraintInterval *PciGenericInterval(IMemoryPool *mp,
													   CMDAccessor *md_accessor,
		...
		static CExpression *PexprScalarCmpIdentToConstant(IMemoryPool *mp, CExpression *pexpr);

		// helper for generating an exists subquery
		static CExpression *PexprExistsSubquery(IMemoryPool *mp, CExpression *pexprOuter);

		// helper for generating a not exists subquery
		static CExpression *PexprNotExistsSubquery(IMemoryPool *mp, CExpression *pexprOuter);

		// helper for generating an ANY subquery
		static CExpression *PexpSubqueryAny(IMemoryPool *mp, CExpression *pexprOuter);

		// helper for generating an ALL subquery
		static CExpression *PexpSubqueryAll(IMemoryPool *mp, CExpression *pexprOuter);
		...
		static CExpression *PexprScIdentCmpConst(IMemoryPool *mp,
												 CExpression *pexprRelational,
												 IMDType::ECmpType cmp_type,
												 ULONG ulVal);

		// generate a scalar expression comparing scalar identifiers
		static CExpression *PexprScIdentCmpScIdent(IMemoryPool *mp,
												   CExpression *pexprLeft,
												   CExpression *pexprRight,
												   IMDType::ECmpType cmp_type);

		// generate a scalar AND expression
		static CExpression *PexprAnd(IMemoryPool *mp, CExpression *pexprFst, CExpression *pexprSnd);

		// generate a scalar OR expression
		static CExpression *PexprOr(IMemoryPool *mp, CExpression *pexprFst, CExpression *pexprSnd);
		...
		static CColRefSetArray *createEquivalenceClasses(IMemoryPool *mp,
														 CColRefSet *pcrs,
														 INT setBoundary[]);
	};  // class CTestUtils
	...
	template <class T>
	CExpression *
	CTestUtils::PexprJoinPartitionedOuter(IMemoryPool *mp)
	{
	...
	template <class T>
	CExpression *
	CTestUtils::PexprJoinPartitionedInner(IMemoryPool *mp)
	{
	...
	template <class T>
	CExpression *
	CTestUtils::PexprJoinPartitioned(IMemoryPool *mp, BOOL fOuterPartitioned)
	{
		...
		CExpression *pexprScalar = CUtils::PexprScalarEqCmp(
			mp, CUtils::PexprScalarIdent(mp, colref), CUtils::PexprScalarIdent(mp, pcrPartKey));
	...
	template <class T>
	CExpression *
	CTestUtils::PexprLogicalJoin(IMemoryPool *mp, CExpression *pexprLeft, CExpression *pexprRight)
	{
	...
	template <class T>
	CExpression *
	CTestUtils::PexprLogicalJoin(IMemoryPool *mp)
	{
	...
	template <class T>
	CExpression *
	CTestUtils::PexprLogicalApply(IMemoryPool *mp)
	{
	...
	template <class T>
	CExpression *
	CTestUtils::PexprLogicalApplyWithOuterRef(IMemoryPool *mp)
	{
		CExpression *pexprOuter = PexprLogicalGet(mp);
		CColRefSet *outer_refs =
			CDrvdPropRelational::GetRelationalProperties(pexprOuter->PdpDerive())->PcrsOutput();
		...
		CColRefSet *pcrsOuterRef =
			CDrvdPropRelational::GetRelationalProperties(pexprInner->PdpDerive())->PcrsOuter();
