...
namespace gpopt
{
	...
	private:
		...
		static GPOS_RESULT EresCheckSubqueryType(CExpression *pexpr,
		...
		static GPOS_RESULT EresCheckQuantifiedSubqueryType(CExpression *pexpr,
														   COperator::EOperatorId eopidPresent);
		...
		static void PreprocessWinFuncWithDistinctAggs(IMemoryPool *mp,
		...
		static CExpression *PexprSelectWithLOJHelper(IMemoryPool *mp,
													 CExpression *pexprLOJ,
													 CColRef *colref,
													 BOOL fOuterChildPred,
													 BOOL fCascadedLOJ);
		...
		static GPOS_RESULT EresCompareExpressions(IMemoryPool *mp,
		...
		static CExpression *PexprCreateConvertableArray(IMemoryPool *mp, BOOL fCreateInStatement);
