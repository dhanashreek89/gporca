...
{
	COperator::EOperatorId rgeopid[] = {COperator::EopPhysicalMotionGather,
...
{
	COperator::EOperatorId rgeopid[] = {COperator::EopPhysicalMotionHashDistribute,
										COperator::EopPhysicalMotionRandom,
										COperator::EopPhysicalMotionRoutedDistribute};
...
CEnumeratorTest::EresUnittest_RunCompatibleDistributions()
{
	...
	return CTestUtils::EresRunMinidumps(mp,
										 ...
										 ULONG ulTests)
{
	...
	GPOS_TRY
	{
		...
		eres = CTestUtils::EresCheckPlans(rgszCheckPlans,
										  ulTests,
										  pulTestCounter,
										  1,	// ulSessionId
										  1,	// ulCmdId
...
CEnumeratorTest::EresUnittest_CheckNoMotions()
{
	return EresUnittest_CheckPlans(EopttraceDisableMotions,
								   FHasNoMotions,
...
CEnumeratorTest::EresUnittest_CheckNoMotionBroadcast()
{
	return EresUnittest_CheckPlans(EopttraceDisableMotionBroadcast,
...
CEnumeratorTest::EresUnittest_CheckNoMotionRedistribute()
{
	...
	return EresUnittest_CheckPlans(EopttraceDisableMotionHashDistribute,
...
CEnumeratorTest::EresUnittest_CheckNoMotionGather()
{
	return EresUnittest_CheckPlans(EopttraceDisableMotionGather,
								   FHasNoMotionGather,
...
CEnumeratorTest::EresUnittest_CheckNoSort()
{
	return EresUnittest_CheckPlans(EopttraceDisableSort,
								   FHasNoSort,
...
CEnumeratorTest::EresUnittest_CheckNoSpool()
{
	return EresUnittest_CheckPlans(EopttraceDisableSpool,
								   FHasNoSpool,
...
CEnumeratorTest::EresUnittest_CheckNoPartPropagation()
{
	...
	GPOS_TRY
	{
		eres = EresUnittest_CheckPlans(EopttraceDisablePartPropagation,
...
CEnumeratorTest::EresUnittest_CheckNoOneStageAgg()
{
	return EresUnittest_CheckPlans(EopttraceForceMultiStageAgg,
								   FHasNoOneStageAgg,
