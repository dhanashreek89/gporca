...
//---------------------------------------------------------------------------
IDatum *
CRangeTest::CreateInt2Datum(gpos::IMemoryPool *mp, INT i)
{
...
//---------------------------------------------------------------------------
IDatum *
CRangeTest::CreateInt4Datum(gpos::IMemoryPool *mp, INT i)
{
...
//---------------------------------------------------------------------------
IDatum *
CRangeTest::CreateInt8Datum(gpos::IMemoryPool *mp, INT li)
{
...
//---------------------------------------------------------------------------
GPOS_RESULT
CRangeTest::EresInitAndCheckRanges(IMemoryPool *mp, IMDId *mdid, PfPdatum pf)
{
	CConstExprEvaluatorDefault *pceeval = GPOS_NEW(mp) CConstExprEvaluatorDefault();
	CDefaultComparator comp(pceeval);
	...
	// generate ranges
	mdid->AddRef();
	CRange *prange1 = GPOS_NEW(mp) CRange(mdid,
										  &comp,
										  (*pf)(mp, 10),
										  CRange::EriIncluded,
										  NULL,
	...
	mdid->AddRef();
	CRange *prange2 = GPOS_NEW(mp) CRange(mdid,
										  &comp,
										  NULL,
										  CRange::EriExcluded,
										  (*pf)(mp, 20),
	...
	mdid->AddRef();
	CRange *prange3 = GPOS_NEW(mp) CRange(mdid,
										  &comp,
										  (*pf)(mp, -20),
										  CRange::EriExcluded,
										  (*pf)(mp, 0),
	...
	mdid->AddRef();
	CRange *prange4 = GPOS_NEW(mp) CRange(mdid,
										  &comp,
										  (*pf)(mp, -10),
										  CRange::EriIncluded,
										  (*pf)(mp, 10),
	...
	mdid->AddRef();
	CRange *prange5 = GPOS_NEW(mp) CRange(mdid,
										  &comp,
										  (*pf)(mp, 0),
										  CRange::EriIncluded,
										  (*pf)(mp, 0),
...
//---------------------------------------------------------------------------
void
CRangeTest::TestRangeRelationship(IMemoryPool *mp,
								  CRange *prange1,
								  CRange *prange2,
								  CRange *prange3,
								  CRange *prange4,
...
//---------------------------------------------------------------------------
void
CRangeTest::PrintRange(IMemoryPool *mp, CColRef *colref, CRange *prange)
{
