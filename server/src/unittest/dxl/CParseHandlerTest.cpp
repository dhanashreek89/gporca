...
CParseHandlerTest::EresUnittest()
{
	CUnittest rgut[] = {
		...
		GPOS_UNITTEST_FUNC_THROW(CParseHandlerTest::EresUnittest_ErrSAXParseException,
								 gpdxl::ExmaDXL,
...
CParseHandlerTest::EresUnittest_ErrSAXParseException()
{
	...
	(void) CDXLUtils::GetPlanDXLNode(
		mp, dxl_string, CTestUtils::m_szXSDPath, &plan_id, &plan_space_size);
...
CParseHandlerTest::EresUnittest_Metadata()
{
	return EresUnittest_RunAllPositiveTests(m_rgszMetadataDXLFileNames,
...
CParseHandlerTest::EresUnittest_Statistics()
{
	return EresUnittest_RunAllPositiveTests(m_rgszStatsDXLFileNames,
...
CParseHandlerTest::EresUnittest_RunPlanTests()
{
	return EresUnittest_RunAllPositiveTests(m_rgszPlanDXLFileNames,
...
CParseHandlerTest::EresUnittest_RunQueryTests()
{
	return EresUnittest_RunAllPositiveTests(m_rgszQueryDXLFileNames,
...
CParseHandlerTest::EresUnittest_ScalarExpr()
{
	return EresUnittest_RunAllPositiveTests(m_rgszScalarExprDXLFileNames,
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresUnittest_RunAllPositiveTests(const CHAR *rgszFileNames[],
													ULONG ulFiles,
...
CParseHandlerTest::EresUnittest_RunAllNegativeTests()
{
	...
	// loop over all test files
	for (ULONG ulFileNum = 0; ulFileNum < GPOS_ARRAY_SIZE(m_rgszNegativeTestsFileNames);
		 ulFileNum++)
	{
		GPOS_TRY
		{
			...
			EresParseAndSerializePlan(
				mp, m_rgszNegativeTestsFileNames[ulFileNum], true /* fValidate */
			);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializePlan(IMemoryPool *mp,
											 ...
											 BOOL fValidate)
{
	...
	CDXLNode *root_dxlnode =
		CDXLUtils::GetPlanDXLNode(mp, dxl_string, szValidationPath, &plan_id, &plan_space_size);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializeQuery(IMemoryPool *mp,
											  const CHAR *dxl_filename,
											  BOOL fValidate)
{
	CWStringDynamic str(mp);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializeMetadata(IMemoryPool *mp,
												 const CHAR *dxl_filename,
												 BOOL fValidate)
{
	CWStringDynamic str(mp);
	...
	CWStringDynamic *metadata_str = CDXLUtils::SerializeMetadata(
		mp, mdcache_obj_array, true /*serialize_header_footer*/, true /*indentation*/);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializeMDRequest(IMemoryPool *mp,
												  const CHAR *dxl_filename,
												  BOOL fValidate)
{
	CWStringDynamic str(mp);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializeStatistics(IMemoryPool *mp,
												   const CHAR *dxl_filename,
												   BOOL fValidate)
{
	...
	CWStringDynamic *statistics_str = CDXLUtils::SerializeStatistics(
		mp, &mda, statistics_array, true /*serialize_header_footer*/, true /*indentation*/
	);
...
//---------------------------------------------------------------------------
GPOS_RESULT
CParseHandlerTest::EresParseAndSerializeScalarExpr(IMemoryPool *mp,
												   const CHAR *dxl_filename,
												   BOOL fValidate)
{
	// read DXL file
	...
	// the root of the parsed DXL tree
	CDXLNode *root_dxlnode =
		CDXLUtils::ParseDXLToScalarExprDXLNode(mp, dxl_string, szValidationPath);
	GPOS_CHECK_ABORT;
	...
	CWStringDynamic *scalar_expr_str = CDXLUtils::SerializeScalarExpr(
		mp, root_dxlnode, true /*serialize_header_footer*/, true /*indentation*/);
	GPOS_CHECK_ABORT;
