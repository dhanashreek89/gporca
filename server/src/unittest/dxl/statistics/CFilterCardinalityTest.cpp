...
GPOS_RESULT
CFilterCardinalityTest::EresUnittest_CStatistics(SStatsFilterSTestCase rgstatsdisjtc[],
												 ULONG ulTestCases)
{
	// create memory pool
	CAutoMemoryPool amp;
	...
	for (ULONG ul = 0; ul < ulTestCases; ul++)
	{
		...
		CStatisticsArray *pdrgpstatBefore = CDXLUtils::ParseDXLToOptimizerStatisticObjArray(
		...
		GPOS_RESULT eres = EresUnittest_CStatisticsCompare(
			mp, md_accessor, pdrgpstatBefore, disjunctive_pred_stats, szDXLOutput);
...
CStatsPred *
CFilterCardinalityTest::PstatspredNullableCols(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspred = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	pdrgpstatspred->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptLEq, CTestUtils::PpointInt4(mp, 1)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredWithNullConstant(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspred = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	pdrgpstatspred->Append(GPOS_NEW(
		mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4NullVal(mp)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredNotNull(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspred = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	pdrgpstatspred->Append(GPOS_NEW(
		mp) CStatsPredPoint(1, CStatsPred::EstatscmptNEq, CTestUtils::PpointInt4NullVal(mp)));
...
CFilterCardinalityTest::EresUnittest_CStatisticsFilterDisj()
{
	SStatsFilterSTestCase rgstatsdisjtc[] = {
		{"../data/dxl/statistics/Disj-Input-1.xml",
		 "../data/dxl/statistics/Disj-Output-1.xml",
		 PstatspredDisj1},
		{"../data/dxl/statistics/Disj-Input-1.xml",
		 "../data/dxl/statistics/Disj-Output-1.xml",
		 PstatspredDisj2},
		...
		{"../data/dxl/statistics/Disj-Input-2.xml",
		 "../data/dxl/statistics/Disj-Output-2-1.xml",
		 PstatspredDisj4},
		{"../data/dxl/statistics/Disj-Input-2.xml",
		 "../data/dxl/statistics/Disj-Output-2-2.xml",
		 PstatspredDisj5},
		{"../data/dxl/statistics/Disj-Input-2.xml",
		 "../data/dxl/statistics/Disj-Output-2-3.xml",
		 PstatspredDisj6},
		{"../data/dxl/statistics/Disj-Input-2.xml",
		 "../data/dxl/statistics/Disj-Output-2-4.xml",
		 PstatspredDisj7},
		{"../data/dxl/statistics/NestedPred-Input-10.xml",
		 "../data/dxl/statistics/Disj-Output-8.xml",
		 PstatspredDisj8},
	};
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisj1(IMemoryPool *mp)
{
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisj2(IMemoryPool *mp)
{
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisj3(IMemoryPool *mp)
{
...
// create an or filter
CStatsPred *
CFilterCardinalityTest::PstatspredDisj4(IMemoryPool *mp)
{
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisj5(IMemoryPool *mp)
{
...
//	create an or filter
CStatsPred *
CFilterCardinalityTest::PstatspredDisj6(IMemoryPool *mp)
{
	...
	pdrgpstatspredDisj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptG, CTestUtils::PpointInt4(mp, 10)));
	pdrgpstatspredDisj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptL, CTestUtils::PpointInt4(mp, 5)));
...
// create an or filter
CStatsPred *
CFilterCardinalityTest::PstatspredDisj7(IMemoryPool *mp)
{
	...
	CStatsPredPtrArry *pdrgpstatspredDisj =
		PdrgpstatspredInteger(mp, 1, CStatsPred::EstatscmptGEq, rgiVal, ulVals);
	pdrgpstatspredDisj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptLEq, CTestUtils::PpointInt4(mp, 15)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisj8(IMemoryPool *mp)
{
...
CFilterCardinalityTest::EresUnittest_CStatisticsFilterConj()
{
	SStatsFilterSTestCase rgstatsdisjtc[] = {
		{"../data/dxl/statistics/NestedPred-Input-9.xml",
		 "../data/dxl/statistics/NestedPred-Output-9.xml",
		 PstatspredConj},
	};
...
CStatsPred *
CFilterCardinalityTest::PstatspredConj(IMemoryPool *mp)
{
	...
	pdrgpstatspredConj3->Append(GPOS_NEW(
		mp) CStatsPredPoint(594,
							CStatsPred::EstatscmptEq,
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrW, 160621100)));
	pdrgpstatspredConj3->Append(GPOS_NEW(
		mp) CStatsPredPoint(592, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2001)));
	pdrgpstatspredConj3->Append(
		GPOS_NEW(mp) CStatsPredPoint(593, CStatsPred::EstatscmptG, CTestUtils::PpointInt4(mp, 0)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredNestedPredDiffCol1(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	// predicate col_1 <> 3
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptNEq, CTestUtils::PpointInt4(mp, 3)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredNestedPredDiffCol2(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
...
CStatsPred *
CFilterCardinalityTest::PstatspredNestedPredCommonCol1(IMemoryPool *mp)
{
	...
	// predicate col_2 == 2
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(2, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2)));
...
// are on the same columns
CStatsPred *
CFilterCardinalityTest::PstatspredNestedPredCommonCol2(IMemoryPool *mp)
{
...
CStatsPred *
CFilterCardinalityTest::PstatspredNestedSharedCol(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	...
	pdrgpstatspredDisj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 4)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjSameCol1(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	// predicate col_1 = 3 AND col_1 >=3
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 3)));
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptGEq, CTestUtils::PpointInt4(mp, 3)));
	...
	CStatsPredPtrArry *pdrgpstatspredDisj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	pdrgpstatspredDisj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 1)));
...
// create nested AND and OR predicates where the AND and OR predicates share common columns
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjSameCol2(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);

	// predicate col_1 <= 5 AND col_1 >=1
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptLEq, CTestUtils::PpointInt4(mp, 5)));
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptGEq, CTestUtils::PpointInt4(mp, 1)));
...
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjSameCol3(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredDisj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	...
	pdrgpstatspredConj1->Append(GPOS_NEW(
		mp) CStatsPredPoint(142,
							CStatsPred::EstatscmptEq,
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrS, 160588332)));
	pdrgpstatspredConj1->Append(GPOS_NEW(
		mp) CStatsPredPoint(113, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2001)));
	...
	pdrgpstatspredConj2->Append(GPOS_NEW(
		mp) CStatsPredPoint(142,
							CStatsPred::EstatscmptEq,
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrS, 160588332)));
	pdrgpstatspredConj2->Append(GPOS_NEW(
		mp) CStatsPredPoint(113, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2002)));
	...
	pdrgpstatspredConj4->Append(GPOS_NEW(
		mp) CStatsPredPoint(142,
							CStatsPred::EstatscmptEq,
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrW, 160621100)));
	pdrgpstatspredConj4->Append(GPOS_NEW(
...
// create disjunctive predicate over conjunctions on same columns
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjSameCol4(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredDisj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	...
	CStatsPredPtrArry *pdrgpstatspredConj1 = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	pdrgpstatspredConj1->Append(GPOS_NEW(
		mp) CStatsPredPoint(91,
							CStatsPred::EstatscmptEq,
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrS, 160588332)));
	pdrgpstatspredConj1->Append(GPOS_NEW(
		mp) CStatsPredPoint(61, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2001)));
	pdrgpstatspredConj1->Append(
		GPOS_NEW(mp) CStatsPredPoint(90, CStatsPred::EstatscmptG, CTestUtils::PpointInt4(mp, 0)));
	pdrgpstatspredDisj->Append(GPOS_NEW(mp) CStatsPredConj(pdrgpstatspredConj1));
	...
	pdrgpstatspredConj2->Append(GPOS_NEW(
		mp) CStatsPredPoint(91,
							...
							CCardinalityTestUtils::PpointGeneric(mp, GPDB_TEXT, pstrS, 160588332)));
	pdrgpstatspredConj2->Append(GPOS_NEW(
		mp) CStatsPredPoint(61, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2002)));
	pdrgpstatspredDisj->Append(GPOS_NEW(mp) CStatsPredConj(pdrgpstatspredConj2));
...
// create nested AND and OR predicates where the AND and OR predicates share common columns
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjDifferentCol1(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	...
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 3)));
	pdrgpstatspredConj->Append(
		GPOS_NEW(mp) CStatsPredPoint(2, CStatsPred::EstatscmptGEq, CTestUtils::PpointInt4(mp, 3)));
...
// create nested AND and OR predicates where the AND and OR predicates
CStatsPred *
CFilterCardinalityTest::PstatspredDisjOverConjMultipleIdenticalCols(IMemoryPool *mp)
{
	CStatsPredPtrArry *pdrgpstatspredConj1 = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	...
	pdrgpstatspredConj1->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 1)));
	pdrgpstatspredConj1->Append(
		GPOS_NEW(mp) CStatsPredPoint(2, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 1)));
	...
	pdrgpstatspredConj2->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2)));
	pdrgpstatspredConj2->Append(
		GPOS_NEW(mp) CStatsPredPoint(2, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 2)));
...
CFilterCardinalityTest::EresUnittest_CStatisticsBasicsFromDXLNumeric()
{
	...
	for (ULONG ul = 0; ul < length; ul++)
	{
		...
		GPOS_RESULT eres = EresUnittest_CStatisticsCompare(
			mp, md_accessor, pdrgpstatBefore, pred_stats, szDXLOutput, true /*fApplyTwice*/
		);
...
CStatsPredPtrArry *
CFilterCardinalityTest::PdrgpstatspredInteger(IMemoryPool *mp,
											  ULONG colid,
											  ...
											  ULONG ulVals)
{
	...
	{
		pdrgpstatspred->Append(GPOS_NEW(
			mp) CStatsPredPoint(colid, stats_cmp_type, CTestUtils::PpointInt4(mp, piVals[ul])));
	}
...
CStatsPredPtrArry *
CFilterCardinalityTest::PdrgppredfilterNumeric(IMemoryPool *mp,
											   ULONG colid,
...
CFilterCardinalityTest::EresUnittest_CStatisticsBasicsFromDXL()
{
	...
	GPOS_RESULT eres =
		EresUnittest_CStatisticsCompare(mp, md_accessor, pdrgpstatsBefore, pred_stats, szDXLOutput);
...
GPOS_RESULT
CFilterCardinalityTest::EresUnittest_CStatisticsCompare(IMemoryPool *mp,
														...
														BOOL fApplyTwice)
{
	...
	GPOS_RESULT eres =
		CTestUtils::EresCompare(oss, pstrOutput, &dstrExpected, false /* ignore mismatch */
		);
	...
	if (fApplyTwice && GPOS_OK == eres)
	{
		...
		CWStringDynamic *pstrOutput2 =
			CDXLUtils::SerializeStatistics(mp,
										   md_accessor,
										   pdrgpstatOutput2,
										   true /*serialize_header_footer*/,
										   true /*indentation*/
			);
		eres = CTestUtils::EresCompare(oss, pstrOutput2, &dstrExpected, false /* ignore mismatch */
		);
...
CFilterCardinalityTest::EresUnittest_CStatisticsAccumulateCard()
{
	...
	for (ULONG ul = 0; ul < num_cols; ul++)
	{
		...
		col_histogram_mapping->Insert(GPOS_NEW(mp) ULONG(ul),
	...
	CStatsPredPtrArry *pdrgpstatspred = GPOS_NEW(mp) CStatsPredPtrArry(mp);
	pdrgpstatspred->Append(
		GPOS_NEW(mp) CStatsPredPoint(0, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 5)));
	pdrgpstatspred->Append(
		GPOS_NEW(mp) CStatsPredPoint(1, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 200)));
	pdrgpstatspred->Append(
		GPOS_NEW(mp) CStatsPredPoint(2, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 200)));
	...
	pdrgpstatspred1->Append(
		GPOS_NEW(mp) CStatsPredPoint(0, CStatsPred::EstatscmptEq, CTestUtils::PpointInt4(mp, 5)));
	CStatsPredConj *pstatspredConj1 = GPOS_NEW(mp) CStatsPredConj(pdrgpstatspred1);

	// apply filter and print resulting stats
	CStatistics *pstats2 =
		CFilterStatsProcessor::MakeStatsFilter(mp, stats, pstatspredConj1, true /* do_cap_NDVs */);
	...
	GPOS_RTL_ASSERT(num_rows1 - num_rows2 < 10 &&
	...
	// apply filter and print resulting stats
	CStatistics *pstats3 =
		CFilterStatsProcessor::MakeStatsFilter(mp, stats, pstatspredConj2, true /* do_cap_NDVs */);
	...
	GPOS_RTL_ASSERT(dRows3 < num_rows2 &&
	...
	// apply filter and print resulting stats
	CStatistics *pstats4 =
		CFilterStatsProcessor::MakeStatsFilter(mp, stats, pstatspredDisj1, true /* do_cap_NDVs */);
	...
	GPOS_RTL_ASSERT(dRows4 < num_rows2 &&
	...
	// apply filter and print resulting stats
	CStatistics *pstats5 =
		CFilterStatsProcessor::MakeStatsFilter(mp, stats, pstatspredConj3, true /* do_cap_NDVs */);
	...
	GPOS_RTL_ASSERT(dRows5 < num_rows2 &&
