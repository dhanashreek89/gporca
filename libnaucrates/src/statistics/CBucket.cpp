...
//---------------------------------------------------------------------------
CBucket *
CBucket::MakeBucketScaleUpper(IMemoryPool *mp, CPoint *point_upper_new, BOOL include_upper) const
{
	GPOS_ASSERT(mp);
...
//---------------------------------------------------------------------------
CBucket *
CBucket::MakeBucketScaleLower(IMemoryPool *mp, CPoint *point_lower_new, BOOL include_lower) const
{
	GPOS_ASSERT(mp);
